      ...
      <div className="flex flex-col gap-10 container">
        ...
        <div className="flex flex-col items-center justify-center text-center space-y-5">
          ...
          <div className="flex items-center gap-5">
            ...
            <a className="hover:text-green-300 transition duration-300 cursor-pointer">
              <svg
        ...
        {/* bottom section */}
        <div className="w-full flex flex-col md:flex-row items-center justify-between gap-4 border-t border-green-700 pt-6">

          <p className="text-gray-300 text-center md:text-left text-sm">
            Copyright © {new Date().getFullYear()} - All right reserved by Kamal
          </p>

          <ul className="text-gray-400 text-sm flex flex-wrap justify-center gap-6">
